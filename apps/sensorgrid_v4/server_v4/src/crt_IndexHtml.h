...
<body>
  <nav style="background:#333; padding:0.5rem 1rem; display:flex; gap:1.5rem; font-family:system-ui,sans-serif;">
    <a href="/" style="color:#fff; text-decoration:none; font-weight:600;">Home</a>
    <a href="/grid" style="color:#ccc; text-decoration:none;">Grid View</a>
  </nav>
  <div class="page">
