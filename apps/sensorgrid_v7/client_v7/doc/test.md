# client_v7 Test Results

## Test Environment
- Server: server_v7 running on ACM3
- Sensors: sensor_v7 (ID=1) on ACM1, sensor_v7 (ID=2) on ACM0, sensor_v7 (ID=3) on USB0 — all in stub mode (no MCP23017 connected), 128 measurements each, 2 ESP-NOW packets per sensor
- Client: client_v7 on ACM2
