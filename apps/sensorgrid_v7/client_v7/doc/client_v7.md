...
![client_v7 object model](img/client_v7_object_model.svg)

### Object List

| Object | Stereotype | Responsibility |
|--------|-----------|---------------|
| **ClientNode** | control | Orchestrates the test sequence: connects to WiFi, executes 9 HTTP tests against the server's endpoints (dashboard, grid page, JSON APIs, download button, 404 handling), validates responses, and logs results. |
